...
namespace Plot
{
    public partial class UcPlot : UserControl
    {
        public Figure fig = new Plot.Figure(123, 123);
        ...
        public void SaveDialog(string filename)
        {
            ...
            savefile.InitialDirectory = System.IO.Path.Combine(Application.StartupPath, @"Screen");
            savefile.Filter = "PNG Files (*.png)|*.png|JPEG Files (*.jpg)|*.jpg|BMP Files (*.bmp)|*.bmp|All files (*.*)|*.*";
